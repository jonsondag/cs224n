...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE
        embedding_tensor = tf.convert_to_tensor(self.pretrained_embeddings)
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        W = tf.Variable(xavier_weight_init()((self.config.n_features * self.config.embed_size,
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        loss_by_example = tf.nn.softmax_cross_entropy_with_logits(labels=self.labels_placeholder, logits=pred)
